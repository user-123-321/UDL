...
class NCMinibatchTrainer(NCTrainer):
    r"""
        ...
        Base:
            ``NCTrainer``
    """
    def __init__(self, model, scenario, optimizer_fn, loss_fn, device, batch_size=131072, **kwargs):
        super().__init__(model.to(device), scenario, optimizer_fn, loss_fn, device, **kwargs)
        self.scheduler_fn = kwargs['scheduler_fn']
    ...
    def prepareLoader(self, curr_dataset, curr_training_states):
        ...
        train_loader = dgl.dataloading.DataLoader(
            ...
            shuffle=True,
            drop_last=False,
            num_workers=0, worker_init_fn=self._dataloader_seed_worker, generator=g_train)
        ...
        val_loader = dgl.dataloading.DataLoader(
            ...
            shuffle=False,
            drop_last=False,
            num_workers=0, worker_init_fn=self._dataloader_seed_worker, generator=g_val)
        ...
        test_loader = dgl.dataloading.DataLoader(
            ...
            shuffle=False,
            drop_last=False,
            num_workers=0, worker_init_fn=self._dataloader_seed_worker, generator=g_test)
        
        # val_loader.enable_cpu_affinity()
